...
yes | lvcreate -L 22G proc -n root

yes | lvcreate -L 12G proc -n vars

yes | lvcreate -L 500M proc -n vtmp

yes | lvcreate -L 1G proc -n vlog

yes | lvcreate -L 500M proc -n vaud
